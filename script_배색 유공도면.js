...
function drawRectangle() {
    ...
    const blackWhitelSpacing = Number(document.getElementById('blackWhitelSpacing').value);
    ...
    // 배색 라인 그리기
    const blackWhitelSpacing_x_start = x+width/2-blackWhitelSpacing/2;
    const blackWhitelSpacing_x_end = blackWhitelSpacing_x_start + blackWhitelSpacing;
    drawDimensionLine_simple(blackWhitelSpacing_x_start, y,blackWhitelSpacing_x_start, y+height)
    drawDimensionLine_simple(blackWhitelSpacing_x_end, y, blackWhitelSpacing_x_end, y+height)
    //console.log("x위치: " +x);
    //console.log("x+배색위치: " +x+100/2);
    ...
    blackWhitelSpacing_dimension_y = indiv_dimension_y + 15;
    total_dimension_y = blackWhitelSpacing_dimension_y + 15;
    ...
    // 배색 폭표시 및 치수선 세로 제외
    drawDimensionLine(blackWhitelSpacing_x_start,blackWhitelSpacing_dimension_y,blackWhitelSpacing_x_end,blackWhitelSpacing_dimension_y,`${blackWhitelSpacing}`)
    ...
    lineHeight = 14;
    ctx.fillStyle = 'black';
    ctx.fillText("폭 " +width+ "["+blackWhitelSpacing+"]", center_X, bot_center_Y);
...
function downloadPNG() {
    ...
    // 파일명 생성
    const fileName = `${formattedDate}_${width}[${blackWhitelSpacing}]_${horizontalSpacing}x${verticalSpacing}_${holeCount}구_${holeSize}파이.png`;
...
function downloadPDF() {
    ...
    // 파일명 생성
    const fileName = `${formattedDate}_${width}[${blackWhitelSpacing}]_${horizontalSpacing}x${verticalSpacing}_${holeCount}구_${holeSize}파이.pdf`;
